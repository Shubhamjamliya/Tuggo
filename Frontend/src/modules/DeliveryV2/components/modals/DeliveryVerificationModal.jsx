      ...
      >
          ...
          <div className="flex items-center justify-center mb-6">
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold transition-all ${isOtpVerified || isAlreadyVerified
                ...
                {!isPaid && (
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className={`w-full py-3.5 sm:py-4 border-2 rounded-2xl font-bold text-[11px] sm:text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${paymentStatus === 'pending'
          ...
          <AnimatePresence>
            {showQrModal && (
              <motion.div
                ...
                className="fixed inset-0 z-[1000] bg-black/80 flex items-center justify-center p-4 sm:p-6 pointer-events-auto"
                onClick={() => setShowQrModal(false)}
              >
                <motion.div
                  initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }}
                  className="bg-white w-full max-w-sm rounded-3xl p-5 sm:p-8 flex flex-col items-center text-center shadow-2xl relative z-[1001]"
